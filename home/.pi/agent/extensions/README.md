...
- `pr-watch.ts`: session-local multi-PR watcher that wakes after PR/git push activity, batches CI and feedback updates until the agent settles, supports paused delivery while polling continues, and shares worker watch membership with parent orchestration sessions
