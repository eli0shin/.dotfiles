- Start by reading any project `AGENTS.md`, `CLAUDE.md`, or `README.md` files that exist in the current directory only. Never search for these files in the parent directory
