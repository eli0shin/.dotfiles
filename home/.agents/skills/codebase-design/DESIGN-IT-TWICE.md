...
Generate 3+ **radically different** interfaces for the deepened module. Define a separate technical brief for each design before producing any of them: file paths, coupling details, dependency category from [DEEPENING.md](DEEPENING.md), and what sits behind the seam. Give each design a different constraint:
